...
public class DBMovies {
    ...
    public ArrayList<Movie> getAllMoviesBoxOffice() {
        ...
        String[] columns = new String[]{MoviesHelper.COLUMN_UID, MoviesHelper.COLUMN_TITLE, MoviesHelper.COLUMN_RELEASE_DATE, MoviesHelper.COLUMN_AUDIENCE_SCORE, MoviesHelper.COLUMN_SYNOPSIS, MoviesHelper.COLUMN_URL_THUMBNAIL, MoviesHelper.COLUMN_URL_SELF, MoviesHelper.COLUMN_URL_CAST, MoviesHelper.COLUMN_URL_REVIEWS, MoviesHelper.COLUMN_URL_SIMILAR};
    ...
    private static class MoviesHelper extends SQLiteOpenHelper {
        ...
        //private static final String CREATE_TABLE_BOX_OFFICE = "CREATE TABLE " + TABLE_BOX_OFFICE + " (" + COLUMN_UID + " INTEGER PRIMARY KEY AUTOINCREMENT" + COLUMN_TITLE + " TEXT" + COLUMN_RELEASE_DATE + " INTEGER" + COLUMN_AUDIENCE_SCORE + " INTEGER" + COLUMN_SYNOPSIS + " TEXT" + COLUMN_URL_THUMBNAIL + " TEXT" + COLUMN_URL_SELF + " TEXT" + COLUMN_URL_CAST + " TEXT" + COLUMN_URL_REVIEWS + " TEXT" + COLUMN_URL_SIMILAR + " TEXT" + " );";
        //private static final String CREATE_TABLE_BOX_OFFICE ="CREATE TABLE " +  TABLE_BOX_OFFICE + " (" + COLUMN_UID + " INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, " + COLUMN_TITLE + " TEXT," + COLUMN_RELEASE_DATE + " INTEGER," + COLUMN_AUDIENCE_SCORE + " INTEGER," + COLUMN_SYNOPSIS + " TEXT," + COLUMN_URL_THUMBNAIL + " TEXT," + COLUMN_URL_SELF + " TEXT," + COLUMN_URL_CAST + " TEXT," + COLUMN_URL_REVIEWS + " TEXT," + COLUMN_URL_SIMILAR + " TEXT,"+ ");";
